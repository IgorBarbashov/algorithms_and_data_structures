# за один проход находим два самых максимальных и два самы минимальных числа
# сравниваем их попарные произведения, выбираем максимальное
...
def multiply(seq):
    ...
    if len(seq) == 2:
        return seq if seq[0] < seq[1] else [seq[1], seq[0]]
